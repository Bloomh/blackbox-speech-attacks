...
if __name__ == "__main__":
    ...
    ensemble_versions = ["v1", "v2", "v1", "v2", "v1"] # we might have more of each if we get pretrained models on diff datasets
    ensemble_training_sets = ["librispeech", "ted", "ted", "an4", "an4"]
